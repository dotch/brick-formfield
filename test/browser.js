...
window.addEventListener('WebComponentsReady', function() {
  ...
  document.head.innerHTML += '<link rel="import" id="el" href="/base/src/brick-formfield.html">';

  document.querySelector('#el').addEventListener('load', function() {

    // Create the custom element.
    var customElement = document.createElement('brick-formfield');
...
describe("the brick-formfield", function(){

  it("should be attached to the DOM", function(){
    expect(document.querySelector("brick-formfield")).not.to.be.null;
  });
